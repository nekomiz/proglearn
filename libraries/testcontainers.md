...
- [Вы использовали Testcontainers совместно с каким-нибудь фреймворком для тестирования (например, Spring Boot)? Если да, то какие особенности возникли?](#вы-использовали-testcontainers-совместно-с-каким-нибудь-фреймворком-для-тестирования-например-spring-boot-если-да-то-какие-особенности-возникли)
- [Как вы справляетесь с проблемой утечки ресурсов при использовании Testcontainers?](#как-вы-справляетесь-с-проблемой-утечки-ресурсов-при-использовании-testcontainers)
- [Были ли у вас случаи, когда Testcontainers оказывался недостаточно гибким для ваших нужд? Как вы решали эту проблему?](#были-ли-у-вас-случаи-когда-testcontainers-оказывался-недостаточно-гибким-для-ваших-нужд-как-вы-решали-эту-проблему)
- [Как вы настраиваете логгирование для контейнеров, запущенных через Testcontainers?](#как-вы-настраиваете-логгирование-для-контейнеров-запущенных-через-testcontainers)
